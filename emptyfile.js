...
async function emptyfile()
{
    await driver.wait(until.elementLocated(driver.findElement(By.css("#id__33"))),3000).click();
    await driver.findElement(By.css("#id__33-menu > div > ul > li:nth-child(1) > button > div > span")).click().sleep(50000).sendKeys("C:/Users/balag/Desktop/konika projec/emptyfile").sleep(50000);
    ...
    if (assert.equal(driver.findElement(By.className("OperationMonitor-itemDescription")).getText == "Sorry, OneDrive can't upload empty folders or empty files. Please try again.")) {
       console.log("tried uploading 0 byte file");
